...
then
    LCG_RELEASE=96
    source /cvmfs/sft.cern.ch/lcg/views/LCG_${LCG_RELEASE}python3/x86_64-centos7-gcc8-opt/setup.sh
else
    source /cvmfs/sft.cern.ch/lcg/views/LCG_${LCG_RELEASE}python3/x86_64-slc6-gcc8-opt/setup.sh
fi
